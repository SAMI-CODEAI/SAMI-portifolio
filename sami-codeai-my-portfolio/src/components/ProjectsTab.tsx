...
const projectList = [
  {
    title: "Competitive Programming Mentor — MCP Server",
    description: "A production-grade Model Context Protocol (MCP) server that decomposes competitive programming expertise into 23 modular, provider-independent tools — orchestrated by any MCP-compatible client. Features schema-first validation, two-tier caching, and provider independence (OpenAI & Ollama).",
    tags: ["Python", "MCP", "FastMCP", "Pydantic", "Jinja2"],
    icon: "🏆",
    url: "https://github.com/SAMI-CODEAI/MCP-Server-For-Competitive-Programming"
  },
  {
      ...
      {projectList.map((proj, idx) => (
        <div key={idx} className="project-card">
          <div className="flex items-start gap-3 mb-3">
            ...
            {proj.url ? (
              <a href={proj.url} target="_blank" rel="noopener noreferrer" className="text-green-300 font-semibold flex-1 hover:underline hover:text-green-400 transition-colors">
                {proj.title}
              </a>
            ) : (
